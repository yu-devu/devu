        ...
        <div className="mypage-mobile">
          ...
          <table className="bottom-mypage">
            <tr className="cate-mypage">
              ...
              {
                {
                  isStudy: <th width="79">상태</th>,
                  isQuestion: <th width="79">상태</th>,
                  isChat: null,
                }[isPostStatus]
              }
            </tr>
                      ...
                      isStudy: myPostStudy
                        ...
                        .map((post) => (
                          <tr className="cate-mypage-detail">
                            ...
                            <td width="70">{post.commentsSize}</td>
                            <td width="79">{post.studyStatus}</td>
                          </tr>
                        )),
                      isQuestion: myPostQuestion
                        ...
                        .map((post) => (
                          <tr className="cate-mypage-detail">
                            ...
                            <td width="70">{post.commentsSize}</td>
                            <td width="79">{post.questionStatus}</td>
                          </tr>
                        )),
                      isChat: myPostChat
                        .slice(0, myPostChat.length)
                        .map((post) => (
                          <tr className="cate-mypage-detail">
                            <td
                              className="cate-mypage-detail-title"
