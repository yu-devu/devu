    ...
    const res = await axios
      ...
      .get(
        process.env.REACT_APP_DB_HOST +
          '/apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst?serviceKey=PyNY0qeRt39Rj07xn2QCs%2BokqrxCfg%2FJkw0RaONPBX3GybvBQjznoLKfITYrjhDTz7bKwND%2BozBbbqHwS89T7Q%3D%3D&numOfRows=10&pageNo=1&base_date=20220523&base_time=2300&nx=92&ny=90&dataType=JSON',
        {
          headers: {
            ...
            <div className="chatbot-content">
              <div className="top-chatbot">
                ...
                <button className="btn-close" onClick={closeModal}>
                  <img className="img-remove" src={remove} alt="" />
                </button>
              </div>
