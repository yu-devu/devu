...
const Jobs = () => {
    ...
    const fetchData = async () => {
        if (company === 'all') {
            ...
            const res = await axios.get(
                process.env.REACT_APP_DB_HOST + `/api/position/naver`,
                {
                    params: {
                        page: currentPage,
                    },
            ...
            const res = await axios.get(
                process.env.REACT_APP_DB_HOST + `/api/position/kakao`,
                {
                    params: {
                        page: currentPage,
                    },
            ...
            const res = await axios.get(
                process.env.REACT_APP_DB_HOST + `/api/position/line`,
                {
                    params: {
                        page: currentPage,
                    },
            ...
            const res = await axios.get(
                process.env.REACT_APP_DB_HOST + `/api/position/coupang`,
                {
                    params: {
                        page: currentPage,
                    },
            ...
            const res = await axios.get(
                process.env.REACT_APP_DB_HOST + `/api/position/baemin`,
                {
                    params: {
                        page: currentPage,
                    },
